...
PROJECT_REPO := github.com/max4t/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 4.44.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-google-beta
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-google-beta_v4.44.1_x5
...
REGISTRY_ORGS ?= xpkg.upbound.io/max4t
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/max4t
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/max4t
XPKGS = $(PROJECT_NAME)
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-gcp-beta: do.build.images
