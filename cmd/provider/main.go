...
import (
	...
	"github.com/max4t/provider-gcp-beta/apis"
	"github.com/max4t/provider-gcp-beta/apis/v1alpha1"
	"github.com/max4t/provider-gcp-beta/config"
...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for GCP Beta").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-gcp-beta"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-gcp-beta",
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup GCP Beta controllers")
