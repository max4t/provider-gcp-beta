...
func externalNameConfig() ujconfig.ResourceOption {
	return func(r *ujconfig.Resource) {
		r.ExternalName = ujconfig.IdentifierFromProvider
	}
}

func groupOverrides() ujconfig.ResourceOption {
	return func(r *ujconfig.Resource) {
...
func defaultVersion() ujconfig.ResourceOption {
	return func(r *ujconfig.Resource) {
		r.Version = VersionV1Beta1
	}
}

func descriptionOverrides() ujconfig.ResourceOption {
	return func(r *ujconfig.Resource) {
		ujconfig.ManipulateEveryField(r.TerraformResource, func(sch *schema.Schema) {
			sch.Description = ""
		})
	}
}
